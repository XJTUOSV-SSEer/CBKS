...
int main(){
    ...
    // inverted_index.insert(std::make_pair("a","1"));
    // inverted_index.insert(std::make_pair("b","2"));
    // inverted_index.insert(std::make_pair("b","3"));
    ...
    // client发送查询请求
    struct request_msg req_msg=client1.search("b");
